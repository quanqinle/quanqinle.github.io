...
- 独立编写[接口测试自动化框架（基于JMeter）](https://github.com/quanqinle/InterfaceTesting)，具有功能：支持录制回放、校验字段、校验返回体JSON结构、数据准备和清理、测试报告输出等。培训团队掌握接口测试原理、用例编写方法。
...
- 为了使性能测试步骤稳定、可重复执行，本人开发了[Web/Android/iOS三合一的UI自动化测试框架](https://github.com/quanqinle/WebAndAppUITesting)，并用其编写自动化测试步骤，完成性能数据采集。
